...
void earth()
{
    auto earth_texture = make_shared<image_texture>("./src/images/earthmap.jpg");
...
void simple_light()
{
    ...
    auto pertext = make_shared<perlin_texture>(0.25);
...
void final_scene(int image_width, int samples_per_pixel, int max_depth)
{
    ...
    auto pertext = make_shared<perlin_texture>(5);
